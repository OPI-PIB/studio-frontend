...
tx_url1 = https://www.transifex.com/api/2/project/navoica-xblocks/resource/studio-frontend/translation/en/strings/
tx_url2 = https://www.transifex.com/api/2/project/navoica-xblocks/resource/studio-frontend/source/
...
pull_translations: ## must be exactly this name for edx tooling support, see ecommerce-scripts/transifex/pull.py
	...
	tx pull -f --mode reviewed --language="pl"

package-lock.validate:
	git diff --name-only --exit-code package-lock.json

copy-dist:
	for f in dist/*; do docker cp $$f navoica.devstack.studio:/edx/app/edxapp/navoica-platform/node_modules/@opipib/studio-frontend/dist/; done
